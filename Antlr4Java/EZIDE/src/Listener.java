...
public class Listener
{
	...
	{
		File file = new File("simple1.py");
		byte[] byteCode = Files.readAllBytes(file.toPath());
		String code = new String(byteCode, Charset.forName("UTF-8")) + "\n";
...
class Listener1 extends Python3BaseListener
{
	...
	{
		System.out.println(Python3Parser.ruleNames[arg0.getRuleIndex()]);
		indentation++;
	}
	...
	{
		System.out.println("ERROR" + arg0.getSymbol());
	}
